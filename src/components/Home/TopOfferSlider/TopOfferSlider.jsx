  ...
  return (
    <div className=" bg-white h-fit">
      <Swiper
        ...
        className="mySwiper w-full md:h-fit"
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="md:grid grid-cols-12 items-center gap-5 p-5 relative h-auto sm:h-auto border rounded shadow">
      ...
      <div className="m-5 hidden md:block  rounded p-5 ">
        <Swiper
          spaceBetween={30}
            ...
            <SwiperSlide key={index}>
              ...
              >
                ...
                <div className="absolute top-[1px] right-[1px] ">
                  <h2 className="w-10 h-10 flex items-center justify-center rounded-full bg-[#395aef] text-white">
                    40%
                  </h2>
                </div>
                <h2>Apple iMac</h2>
